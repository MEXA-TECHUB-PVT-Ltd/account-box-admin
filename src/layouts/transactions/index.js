...
function Users() {
    ...
    const deleteDataProduct = () => {
        // setTimeout(() => {
        axios.delete(`${url}api/invoice/deleteInvoice/${productId}`
            , { headers })
            .then(res => {

                console.log(res.data);
                if (res.data.acknowlwdged === true) {
              ...
              <>
                <Grid container spacing={2}>
                  ...
                  {row.driver_id===undefined||row.driver_id===null?<span>Null</span>:<Avatar src={`${url}${row.driver_id.img}`} />}
                    {/* <Avatar src={`${url}${row.guest_id.img}`} /> */}
                  </Grid>
    ...
    const getAllData = () => {
        axios.get(`${url}api/invoice/allInvoices`)
            .then((response) => {
                                                        ...
                                                        <Grid container spacing={2} align="center">
                                                            <Grid item xs={12} md={12}>
                                                                <Typography id="modal-modal-title" variant="h6" component="h2">
                                                                    Are you sure you want to delete<br/> this Transaction?
                                                                </Typography>
                                                            </Grid>
                                                            <Grid item xs={6} md={6}>
