...
function Users() {
    ...
    let columns = [
        {
            title: 'Name', field: 'hotel_name', width: '20%', render: (row) =>
              <>
                <Grid container spacing={2}>
                  ...
                  {row.hotel_name===undefined?<span>Null</span>:<span>{row.hotel_name}</span>}
                  </Grid>
                </Grid>
              </>
          },
                                                        ...
                                                        <Grid container spacing={2} align="center">
                                                            <Grid item xs={12} md={12}>
                                                                <Typography id="modal-modal-title" variant="h6" component="h2">
                                                                    Are you sure you want to delete<br/> this Hotel?
                                                                </Typography>
                                                            </Grid>
                                                            <Grid item xs={6} md={6}>
