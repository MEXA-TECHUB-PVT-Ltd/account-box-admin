...
function Users() {
    ...
    const deleteDataProduct = () => {
        axios.delete(`${url}api/vehicle/deleteVehicle/${productId}`
            , { headers })
            .then(res => {
    ...
    const renderSuccessSb = (
        <MDSnackbar
            icon="notifications"
            title="Vehicle Blocked Successfully"
            content="This is a notification message"
            open={successSB}
    ...
    let columns = [
        { title: 'Make', field: 'make', width: '10%' },
        { title: 'Modal', field: 'modal', width: '10%' },

        { title: 'Year', field: 'year', width: '10%' },
        { title: 'Color', field: 'color', width: '10%' },
        { title: 'PlateNo', field: 'plate_no', width: '10%' },
        { title: 'Style', field: 'style', width: '10%' },
        {
            title: 'Ac', field: 'ac', width: '20%', render: (row) => <div>
                {row.ac === 'yes' ?
    ...
    const getAllData = () => {
        axios.get(`${url}api/vehicle/allVehicles`)
            .then((response) => {
                                                    ...
                                                    <Grid container spacing={2} align="center">
                                                        <Grid item xs={12} md={12}>
                                                            <Typography id="modal-modal-title" variant="h6" component="h2">
                                                                Are you sure you want to delete<br /> this Vehicle?
                                                            </Typography>
                                                        </Grid>
                                                        <Grid item xs={6} md={6}>
